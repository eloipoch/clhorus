...
(defrecord UserRepositoryComponent []
  ...
  (start [component]
    (assoc component :repository (UserRepositoryMySql. (:database (:database component)))))
...
(defn operational-system [config-options]
  (component/system-map
    ...
    :repository-user (component/using (UserRepositoryComponent.) {:database :database-operational})
